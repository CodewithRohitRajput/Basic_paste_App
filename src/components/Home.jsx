      ...
      <div className='w-full flex justify-center items-center flex-col' >
        ...
        <div className=''>
            <form action="" onSubmit={makeNote}>
                <textarea type="text" placeholder='Whats on your Mind ? ' className=' mt-10 border-4 border-blue-800 rounded-lg w-96 h-56 px-2 py-2 font-sans'  value={note} onChange={(e)=> setNotes(e.target.value)} />
                <br />
...
key={index}
    ...
    className='bg-blue-200 text-black from-neutral-400 w-96 h-40 border-b-4 border-blue-600 mt-16 rounded-xl px-2 py-2  '>
